Vue.component( "footer-content", {
  template: '<div class="container"> \
      <p class="text-muted text-center"> \
        ...
        <br> \
        Source <i class="fa fa-code"></i> available on <a href="https://github.com/mikesprague/vuejs-projects/tree/master/todo-list/public" target="_blank"><i class="fa fa-github"></i> GitHub</a>. \
      </p> \
    </div>'
});
